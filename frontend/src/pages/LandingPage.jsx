  ...
  return (
    <div className="min-h-screen bg-paper flex flex-col font-sans">
      ...
      <main>
        ...
        {/* How it works */}
        <section id="how" className="py-20 px-10 max-w-[1240px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={step.num} className="p-[26px] border border-line rounded-[12px] bg-surface">
        ...
        {/* Features */}
        <section id="features" className="py-20 px-10 max-w-[1240px] mx-auto">
          <div className="section-head">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_1fr] gap-5">
            <div className="bg-ink text-paper rounded-[14px] p-[34px] flex flex-col justify-between lg:row-span-2">
              <div>
              ...
              <div className="mt-[26px] bg-[rgba(192,138,42,.15)] border border-[rgba(192,138,42,.4)] text-amber-soft text-[11.5px] p-3.5 rounded-lg font-mono">
        ...
        {/* CTA */}
        <div className="bg-teal-dark text-white rounded-[18px] p-10 md:p-14 text-center my-20 mx-10 max-w-[1240px] xl:mx-auto">
          <h2 className="text-white text-[30px] font-semibold">Your resume, drafted honestly.</h2>
